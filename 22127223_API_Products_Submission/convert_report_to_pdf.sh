...
pandoc 22127223_API_AI_Report_Products.md \
    -o 22127223_API_AI_Report_Products.pdf \
    --pdf-engine=wkhtmltopdf \
    --css=api_report_style.css \
    --metadata title="API Testing with AI Tools - Individual Report" \
    --metadata author="Student ID: 22127223" \
    --metadata date="January 13, 2025"

if [ $? -eq 0 ]; then
    echo "✅ PDF report generated successfully: 22127223_API_AI_Report_Products.pdf"
else
    echo "⚠️  Error generating PDF. Trying HTML alternative..."
    pandoc 22127223_API_AI_Report_Products.md \
        -o 22127223_API_AI_Report_Products.html \
        --css=api_report_style.css \
        --metadata title="API Testing with AI Tools - Individual Report" \
        --metadata author="Student ID: 22127223" \
        --metadata date="January 13, 2025"
    ...
    if [ $? -eq 0 ]; then
        echo "✅ HTML report generated: 22127223_API_AI_Report_Products.html"
